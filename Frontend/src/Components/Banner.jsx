    ...
    <>
      <div className='min-h-full w-full bg-gray-100 flex flex-col lg:flex-row'>
        ...
        <div className='h-full p-10 w-full lg:w-[60%] bg-green-100'>
          ...
          <div>
            <button className="bg-green-600 rounded-lg hover:bg-green-700 text-white font-bold py-2 px-4 text-center text-xl mt-5">
              Explore
            </button>
          </div>
        </div>
        ...
        {/* Right Section (Image) */}
        <div className='md:h-[80vh] lg:h-[93vh] w-full lg:w-[40%] object-cover'>
          <img
